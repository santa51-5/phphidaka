...
if ($_POST["SUB"]=="一覧表\表\示")
{

  header("Location: "."checklist.asp?action=list");
} 
...
{
  case 1:
    header("Location: "."listing.asp?".("back1"));//& " #" & request.form("checks")(request.form("checks").count)
    break;
  case 2:
    header("Location: "."listing_kekka.asp?".("back1"));//& " #" & request.form("checks")(request.form("checks").count)
    break;
  case 3:
    header("Location: "."listing_yotei.asp?".("back1"));//& " #" & request.form("checks")(request.form("checks").count)
