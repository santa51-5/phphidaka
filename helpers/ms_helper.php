<?php
function store_customersInfo(customerName)

    $sql = 'SELECT * FROM tb_customer WHERE customer_id = :customer_id LIMIT 1';

    $stmt = $dbh->prepare($sql);
    $stmt->bindValue(':customer_id', $customerName, PDO::PARAM_STR);
    $stmt->execute();
